...
} elseif (isset($_GET['userId']) && isset($_GET['file']) && isset($_GET['content']) && isset($_GET['name']) && isset($_GET['subtitle']) && isset($_GET['notebook_id'])) {
    print(json_encode(saveClipping($_GET['userId'], $_GET['notebook_id'], $_GET['file'], $_GET['content'], $_GET['name'], $_GET['subtitle'])));
